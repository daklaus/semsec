...
\begin{frame}[allowframebreaks]{References}
	...
	\nocite{lin:2007:gsis}
	\nocite{guette:2008:using-tpms-to-secure-vehicular-ad-hoc-networks-vanets}
	\nocite{golle:2004:detecting-and-correcting-malicious-data-in-vanets}
	\nocite{xu:2004:vehicle-to-vehicle-safety-messaging-in-dsrc}
	% \nocite{*}
	\printbibliography
\end{frame}
